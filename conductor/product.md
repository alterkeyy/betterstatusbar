...
- **Automated CI/CD & Multi-Arch Support:** Architecture-specific APKs (x86_64, arm64-v8a, armeabi-v7a) are automatically built, signed, and released via GitHub Actions.
- **Systematic Versioning:** Automated version management ensures every build has a unique, chronological version number based on Git history.
