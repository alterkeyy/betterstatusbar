...
## CI/CD
- **GitHub Actions:** Automates the build, sign, and release process. Architecture-specific APKs are uploaded as artifacts and attached to GitHub Releases upon tag creation.
- **Git-based Versioning:** Custom Gradle logic dynamically calculates `versionCode` and `versionName` based on Git commit count.