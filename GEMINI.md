...
- Connects to SystemUI via LibXposed (API 101) hooks.
...
- **LibXposed:** Modifies runtime behavior utilizing LibXposed APIs. The entry point is defined in `app/src/main/resources/META-INF/xposed/java_init.list`.
